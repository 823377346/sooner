...
public enum ResultStatus {
    ...
    USER_PRESENCE(6, "用户已经存在"),

    /**
     * {@code 0 OK 请求成功}.
     */

    ADMIN_ALERT(6, "只有管理员可以创建"),
...
//    OK(200, "OK"),
    ...
    /**
     * Return the enumconstant constant of this type with the specified numeric value.
     *
     * @param statusCode the numeric value of the enumconstant to be returned
     * @return the enumconstant constant with the specified numeric value
     * @throws IllegalArgumentException if this enumconstant has no constant for the specified numeric value
     */
...
//    }
    ...
    public enum Series {
        ...
        /**
         * Return the enumconstant constant of this type with the corresponding series.
         *
         * @param status a standard HTTP status enumconstant value
         * @return the enumconstant constant of this type with the corresponding series
         * @throws IllegalArgumentException if this enumconstant has no corresponding constant
         */
